...
TOKEN_EXCHANGE_GRANT_TYPE = "urn:ietf:params:oauth:grant-type:token-exchange"  # ruff: ignore[hardcoded-password-string]
ACCESS_TOKEN_TYPE = "urn:ietf:params:oauth:token-type:access_token"  # ruff: ignore[hardcoded-password-string]
