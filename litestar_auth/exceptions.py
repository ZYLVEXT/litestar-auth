...
class ErrorCode:
    ...
    TOKEN_PROCESSING_FAILED = "TOKEN_PROCESSING_FAILED"  # noqa: S105
    ...
    RESET_PASSWORD_BAD_TOKEN = "RESET_PASSWORD_BAD_TOKEN"  # noqa: S105
    RESET_PASSWORD_INVALID_PASSWORD = "RESET_PASSWORD_INVALID_PASSWORD"  # noqa: S105
    VERIFY_USER_BAD_TOKEN = "VERIFY_USER_BAD_TOKEN"  # noqa: S105
    ...
    UPDATE_USER_INVALID_PASSWORD = "UPDATE_USER_INVALID_PASSWORD"  # noqa: S105
    ...
    TOTP_PENDING_BAD_TOKEN = "TOTP_PENDING_BAD_TOKEN"  # noqa: S105
    TOTP_CODE_INVALID = "TOTP_CODE_INVALID"
    TOTP_ALREADY_ENABLED = "TOTP_ALREADY_ENABLED"
    TOTP_ENROLL_BAD_TOKEN = "TOTP_ENROLL_BAD_TOKEN"  # noqa: S105
