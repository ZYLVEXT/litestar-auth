...
# [0-9] (not \d): \d matches Unicode digits, which can never be valid codes.
TOTP_VERIFICATION_CODE_PATTERN = rf"^(?:[0-9]{{{TOTP_CODE_LENGTH}}}|[0-9a-f]{{{TOTP_RECOVERY_CODE_LENGTH}}})$"
